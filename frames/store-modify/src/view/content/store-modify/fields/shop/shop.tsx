...
import { ShopListControllerInterface } from '../../../../../classes/controller/shop-list/shop-list-controller.interface.ts';
...
export const Shop: React.FC = () => {
  const shops = useLoaderData(ShopListControllerInterface);

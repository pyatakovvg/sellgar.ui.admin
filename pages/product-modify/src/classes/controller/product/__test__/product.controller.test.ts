...
const createController = () => {
  ...
  return {
    controller: new ProductController(productService, fileService, navigateService, revalidateService),
    fileService,
    navigateService,
    productService,
    revalidateService,
...
const createPayload = (file: File): ProductFormInput => ({
  name: 'Товар',
...
describe('ProductController', () => {
  it('возвращает пустой loader result для create route', async () => {
    ...
    ).resolves.toMatchObject({ imageUrls: {}, product: undefined });

...
import { ProductDtoMapper } from './data/gateway/mapper/product-dto.mapper.ts';
import { ProductDtoMapperInterface } from './data/gateway/mapper/product-dto-mapper.interface.ts';
...
export class ProductBinding extends BindingModuleInterface {
  register(registry: BindingRegistryInterface): void {
    ...
    registry.bind(ProductDtoMapperInterface).to(ProductDtoMapper);

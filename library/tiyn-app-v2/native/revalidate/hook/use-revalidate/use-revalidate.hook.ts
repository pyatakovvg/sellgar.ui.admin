...
export const useRevalidate = (controllerToken?: DependencyToken<unknown>): RevalidateHandler => {
  ...
  const revalidate = React.useCallback(() => runtime.revalidate({ controllerToken }), [controllerToken, runtime]);

  return React.useMemo(
    () => Object.assign(revalidate, { error: runtimeState.error, inProcess: runtimeState.inProcess }),

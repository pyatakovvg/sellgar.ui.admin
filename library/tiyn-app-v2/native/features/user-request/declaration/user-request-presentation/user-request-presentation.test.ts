...
describe('Native UserRequestPresentation', () => {
  it('resolves every configured semantic request view', () => {
  ...
  it('does not resolve a pending request when its view is missing', async () => {

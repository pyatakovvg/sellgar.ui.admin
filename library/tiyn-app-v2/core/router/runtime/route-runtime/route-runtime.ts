...
export type RouteRuntimePhase =
  'active' | 'disposed' | 'empty' | 'failed' | 'forbidden' | 'not-found' | 'pending' | 'preparing';
...
export interface RouteRuntimeCallbacks<TPresentation = unknown> {
  ...
  readonly onRenderFailure?: (runtime: RouteRuntime<TPresentation>, error: unknown) => Promise<void>;
}

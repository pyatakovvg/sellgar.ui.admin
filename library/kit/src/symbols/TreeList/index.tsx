...
import type { ITreeList } from './types';

import st from './styles/default.module.scss';

export const TreeList = <O extends Record<string, any> = {}>(props: ITreeList<O>) => {
            ...
            {props.children && React.isValidElement(props.children) ? (
              ...
              <>
                <OptionList
                  ...
                  isShowControl={!option.children.length}
                ...
                {!!option.children.length && (
                  <div style={{ marginLeft: 24 }}>
                    <TreeList {...props} options={option.children} />
                  </div>
                )}
              </>
            )}
